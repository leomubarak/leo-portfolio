...
/**
 * Four steps plus the level written out. The word is the real signal —
 * the steps only make comparison quicker, so nothing depends on colour.
 */
export function SkillLevelMeter({ level, className }: SkillLevelMeterProps) {
