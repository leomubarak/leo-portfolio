    ...
    <Section id="about">
      <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
        ...
        <Reveal className="order-2 lg:order-1">
          <div className="relative">
            <img
              ...
              alt="Leo seated against a dark background, wearing a striped shirt and flat cap"
              width={1280}
              height={1920}
              loading="lazy"
              decoding="async"
            ...
            <Card
              padding="sm"
              className="absolute right-4 -bottom-8 left-4 border-line-strong sm:right-6 sm:left-6"
            >
        ...
        <div className="order-1 lg:order-2">
          ...
          <Reveal delay={0.1}>
            <div className="mt-10">
              <p className="eyebrow">What I spend time on</p>
              <ul className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {about.interests.map((interest) => {
                  ...
                  return (
                    <li
                      key={interest.label}
                      className="flex items-center gap-3 rounded-xl border border-line bg-surface-raised px-4 py-3"
                    >
