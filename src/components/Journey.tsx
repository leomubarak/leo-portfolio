  ...
  return (
    <Section id="journey" tone="sunken">
      <SectionHeading
        ...
        description="Six steps, in the order they happened. No job titles — this is a learning path, and it is still going."
      />

      <ol className="relative mt-14 space-y-8 sm:space-y-10">
        {/* The rail. Sits behind the markers, stops at the last one. */}
        <span
          aria-hidden="true"
        ...
        {journey.map((milestone, index) => (
          <li key={milestone.id} className="relative pl-16 sm:pl-20">
            {/* Numbered marker — the sequence is real information here. */}
            <span
              aria-hidden="true"
              className={cn(
